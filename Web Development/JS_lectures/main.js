...
// let e = {firstName: "Amir", lastName: "Majeed"}   Objects
// let f = null                                    null
// let i =                                        un-defined
...
// if(a === b){
//     document.write("A is Same ");
// }
// else{
//     document.write("A is not Same ");
// }
...
// let str = "Apple, Orange, Kiwi, blue, red";
// document.getElementById("demo").innerHTML = str.slice(20);

// .................................
//                          substring()      method extracts characters from start to end (exclusive).

// let str = "Apple, Orange, Kiwi, blue, red";
// document.getElementById("demo").innerHTML = str.substring(0, 20);
...
// let str = "Tech Step Sahiwal";
// document.getElementById("demo").innerHTML = str.includes("Step");

// ........................................
//                                  startsWith()        return true or false

//  let str = "Tech Step Sahiwal";
// document.getElementById("demo").innerHTML = str.startsWith("Tech") ;

//                                  endsWith()      also     return true or false 

// let str = "Tech Step Sahiwal";
// document.getElementById("demo").innerHTML = str.endsWith("Step") ;
...
// let str = "Tech Step Sahiwal";
// document.getElementById("demo").innerHTML = str.search("Sahiwal");
...
// document.getElementById("demo").innerHTML = str.match(/Step/g);
...
//                      replace()       method searches a string for a value or a regular expression.
    ...
    // document.getElementById("demo").innerHTML = str.replace("javascript", "PHP");

// document.getElementById("demo").innerHTML = str.replace(/is/g, "are");
...
// document.getElementById("trim2").innerHTML = result;
...
// document.getElementById("demo").innerHTML = str.charAt(12) ;
...
// document.getElementById("demo").innerHTML = str.concat(str2,str3);
...
// document.getElementById("demo").innerHTML = str.split("R");
...
// document.getElementById("demo").innerHTML = str.repeat(10);
...
//    document.write(productsName + "<br>" + desp + "<br>" + price + "<br>");
// }   
...
// document.getElementById("demo").innerHTML = "<p>Tech Step Sahiwal</p>" ;
...
// let a = document.getElementById("inner").childNodes[1];



// let a = document.getElementById("inner").children[0].style.color = "white";
